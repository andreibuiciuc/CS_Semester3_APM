...
public class UI {
    ...
    private void createExample(String example) throws Exception {
        ...
        switch (example) {
            case "1" -> programState = new ProgramState(exeStack, symTable, out, UI.ex1, fileTable);
            case "2" -> programState = new ProgramState(exeStack, symTable, out, UI.ex2, fileTable);
            case "3" -> programState = new ProgramState(exeStack, symTable, out, UI.ex3, fileTable);
